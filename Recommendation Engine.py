...
# import Dataset 
anime = pd.read_csv(r"C:\Users\Shree\Downloads\Recommender_System\Recommender_System\Recommender_System\anime.csv", encoding = 'utf8')

# Database Connection
from sqlalchemy import create_engine

engine = create_engine("mysql+pymysql://{user}:{pw}@localhost/{db}".format(user = "root", pw = "9923", db = "databasee"))
...
def create_similar_show_dataframe(anime, anime_idx, anime_scores):
...
# Example usage:
# anime = ... (your anime DataFrame)
# anime_idx = ... (index of the anime)
# anime_scores = ... (scores of the anime)
# similar_show_df = create_similar_show_dataframe(anime, anime_idx, anime_scores)
# print(similar_show_df)
